...
int Test_validate_username_main(void)
{
  UnityBegin("/home/nihed/Project/assignment-1-Nihed2001/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
  run_test(test_validate_my_username, "test_validate_my_username", 9);
